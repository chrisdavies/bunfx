...
import type { MakeUploader } from './upload';
...
export class RichImg extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.className = 'focus-within:ring-2 ring-offset-2 ring-indigo-600 group/fig';
    this.tabIndex = -1;
    ...
    render(
      <EditableRichImg state={this.state} onDelete={() => deleteBlock(this)} editor={editor} />,
      this,
    );
  }
            ...
            <MenuItem title="Align">
              <MenuRadioSet
                ...
                choices={[
                  ...
                  { value: 'center', isDefault: true, label: <span>Center</span> },
